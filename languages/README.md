...
| Real-time telecom call routing state | [python/telecomCallRoutingState.py](./python/telecomCallRoutingState.py) | Shows TimesTen as a low-latency store for telecom routing decisions, idempotent replay, and hot session state. |
