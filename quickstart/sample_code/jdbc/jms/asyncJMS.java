 ...
 * in syncJMS.java).  TimesTen's JMS/XLA 
...
public class asyncJMS
{
  ...
  /** JMS/XLA topic name */
  private static String topicName = "asyncJMS";
  ...
  public static void main(final String[] args)
  {
    ...
    // Specify the topic "asyncJMS" to get the connection parameters from
    // the asyncJMS demo entry in jmsxla.xml.
    final asyncJMS demo = new asyncJMS();
  ...
  static private void usage()
  {
    ...
    System.err.print("\n" + "Usage: \n\n" + "  asyncJMS [-h] [-help] [-?]\n" + 
                     "  asyncJMS [-topic <topicName>] [-schema <schemaName>]\n" + 
