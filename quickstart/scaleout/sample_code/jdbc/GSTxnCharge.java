...
/**
 * A class that represents the 'Charge' transaction.
 *
 * This transaction applies a charge value to deplete the balance of an
 * account. it also logs an 'audit' record describing the transatcion in
 * the TRANSACTIONS table.
 */
public class GSTxnCharge
    extends GSAppTransaction
{
    ...
    private String txnDescription = "Call Charge";
               ...
               )
    {
        ...
        if (  GSConstants.debugEnabled  )
            GSUtil.debugMessage( cx,
                "DEBUG: ENTER: GSTxnCharge: Constructor" );
        myName = GSConstants.nameCharge;
        if (  GSConstants.debugEnabled  )
            GSUtil.debugMessage( cx,
                "DEBUG: EXIT: GSTxnCharge: Constructor" );
    } // Constructor
                               ...
                               )
    {
        if (  GSConstants.debugEnabled  )
            GSUtil.debugMessage( ctxt, 
                             "DEBUG: ENTER: GSTxnCharge: setAccountID" );
        if (  aID <= 0  )
        {
            errMsg = GSErrors.M_PARAM_ERR;
            if (  GSConstants.debugEnabled  )
                GSUtil.debugMessage( ctxt, 
                             "DEBUG: EXITERR: GSTxnCharge: setAccountID" );
            return false;
        }
        ...
        if (  GSConstants.debugEnabled  )
            GSUtil.debugMessage( ctxt, 
                             "DEBUG: EXITOK: GSTxnCharge: setAccountID" );
        return true;
    } // setAccountID
                            ...
                            )
    {
        if (  GSConstants.debugEnabled  )
            GSUtil.debugMessage( ctxt, 
                             "DEBUG: ENTER: GSTxnCharge: setAmount" );
        if (  amt.compareTo( GSConstants.bdZero ) >= 0  )
        {
            errMsg = GSErrors.M_PARAM_ERR;
            if (  GSConstants.debugEnabled  )
                GSUtil.debugMessage( ctxt, 
                             "DEBUG: EXITERR: GSTxnCharge: setAmount" );
            return false;
        }
        ...
        if (  GSConstants.debugEnabled  )
            GSUtil.debugMessage( ctxt, 
                             "DEBUG: EXITOK: GSTxnCharge: setAmount" );
        return true;
    } // setAmount
    ...
    public void cleanup()
    {
        if (  GSConstants.debugEnabled  )
            GSUtil.debugMessage( ctxt, 
                             "DEBUG: ENTER: GSTxnCharge: cleanup" );
        errMsg = null;
        if (  stmtQuery != null  )
        {
            stmtQuery.close();
        ...
        if (  GSConstants.debugEnabled  )
            GSUtil.debugMessage( ctxt, 
                             "DEBUG: EXIT: GSTxnCharge: cleanup" );
    } // cleanup
               ...
               GSConnectionFailoverException
    {
        ...
        if (  GSConstants.debugEnabled  )
            GSUtil.debugMessage( ctxt, 
                             "DEBUG: ENTER: GSTxnCharge: init" );
        cleanup();
        try {
            stmtQuery = dbConn.prepare( "TxnCharge_Query", sqlQuery );
            if (  stmtQuery != null  )
            {
                stmtUpdate = dbConn.prepare( "TxnCharge_Update",
                                             sqlUpdate );
                if (  stmtUpdate == null  )
                {
                    stmtQuery.close();
                ...
                {
                    stmtInsert = dbConn.prepare( "TxnCharge_Insert",
                                                 sqlInsert );
                    if (  stmtInsert == null  )
                    {
                        stmtQuery.close();
            ...
            if (  GSConstants.debugEnabled  )
                GSUtil.debugMessage( ctxt, 
                             "DEBUG: GSTxnCharge: init: Transient error" );
            throw gre;
        } catch (  GSConnectionFailoverException cfe  ) {
            cleanup();
            if (  GSConstants.debugEnabled  )
                GSUtil.debugMessage( ctxt, 
                             "DEBUG: GSTxnCharge: init: Failover" );
            throw cfe;
        }
        ...
        if (  GSConstants.debugEnabled  )
        {
            if (  result  )
                GSUtil.debugMessage( ctxt, 
                             "DEBUG: EXITOK: GSTxnCharge: init" );
            else
                GSUtil.debugMessage( ctxt, 
                             "DEBUG: EXITERR: GSTxnCharge: init" );
        }
        return result;
    } // init
               ...
               GSConnectionFailoverException
    {
        ...
        {
            GSUtil.debugMessage( ctxt, 
                         "DEBUG: ENTER: GSTxnCharge: execute" );
            GSUtil.debugMessage( ctxt, 
              ...
              (txnDescription == null)  )
        {
            ...
            if (  GSConstants.debugEnabled  )
                GSUtil.debugMessage( ctxt, 
                             "DEBUG: EXITERR: GSTxnCharge: execute" );
            return false;
        }
        ...
        try {
            ...
            if (  GSConstants.debugEnabled  )
                GSUtil.debugMessage( ctxt, 
                    "DEBUG: GSTxnCharge: Transient error" );
            throw gre;
        } catch (  GSConnectionFailoverException cfe  ) {
            if (  GSConstants.debugEnabled  )
                GSUtil.debugMessage( ctxt, 
                    "DEBUG: GSTxnCharge: Failover" );
            throw cfe;
            ...
            dbConn.rollback();
            if (  GSConstants.debugEnabled  )
                GSUtil.debugMessage( ctxt, "DEBUG: GSTxnCharge: Exception" );
            result = false;
        } finally {
            if (  rs != null )
            {
        ...
        if (  GSConstants.debugEnabled  )
        {
            if (  result  )
                GSUtil.debugMessage( ctxt, 
                             "DEBUG: EXITOK: GSTxnCharge: execute" );
            else
                GSUtil.debugMessage( ctxt, 
                             "DEBUG: EXITERR: GSTxnCharge: execute" );
        }
