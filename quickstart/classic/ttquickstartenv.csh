...
if (! ${_bad} ) then
    if ( ! -e "${TIMESTEN_HOME}/bin/ttenv.sh" ) then
        ...
        if ( ! ${?QUICKSTART_HOME} ) then
            ...
            setenv PATH "$QUICKSTART_HOME/sample_code/odbc:$QUICKSTART_HOME/sample_code/proc:$QUICKSTART_HOME/sample_code/oci:$QUICKSTART_HOME/sample_code/odbc/xla:$QUICKSTART_HOME/sample_code/jdbc:$QUICKSTART_HOME/sample_code/odbc_drivermgr:$QUICKSTART_HOME/sample_code/proc:$QUICKSTART_HOME/sample_code/ttclasses:$QUICKSTART_HOME/sample_code/ttclasses/xla:${PATH}"
        
            if (${?LD_LIBRARY_PATH}) then
                setenv LD_LIBRARY_PATH  "${QUICKSTART_HOME}/lib:${LD_LIBRARY_PATH}"
            else
                setenv LD_LIBRARY_PATH "${QUICKSTART_HOME}/lib"
            endif
