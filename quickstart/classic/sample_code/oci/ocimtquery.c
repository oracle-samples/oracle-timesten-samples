...
void usage(){
  ...
  "connections/threads and perform detailed response time measurements. While\n"
  "in theory any SQL statement can be executed this utility is really intended\n"
  "to run queries.\n\n"
  "Usage:\n\n"
  "  ocimtquery [ -h | -help ]\n"
  ...
  "             set of queries (subject to any time limit).\n\n"
  ...
  "             the limit is only applied approximately\n\n"
  ...
  "             and with two '-verbose' additional thread level info is\n"
  "             also output.\n\n"
