...
export CLASSPATH="${QUICKSTART_HOME}/sample_code/jdbc/out:${QUICKSTART_HOME}/sample_code/jdbc/jms/javax/out:${QUICKSTART_HOME}/sample_code/jdbc/jms/jakarta/out${CLASSPATH:+:${CLASSPATH}}"
