...
| :--- | :--------- | :----------------- |
| AI and live application state | [languages/python](./languages/python), [languages/nodejs](./languages/nodejs), [quickstart/sample_code/jdbc](./quickstart/sample_code/jdbc) | Shows TimesTen for response cache, chat memory, agent-workflow, feature state, and other active application data. |
