...
| Real-time telecom call routing state | [languages/python/telecomCallRoutingState.py](./languages/python/telecomCallRoutingState.py), [languages/nodejs/telecomCallRoutingState.js](./languages/nodejs/telecomCallRoutingState.js) | Shows TimesTen as a low-latency store for telecom routing decisions, idempotent replay, and hot session state. |
